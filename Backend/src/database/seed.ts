...
/**
 * Carga datos demo (un asesor y un usuario con gastos/presupuestos) solo
 * cuando la tabla de usuarios esta vacia. Es idempotente.
 */
export const seedDatabase = async (pool: Pool): Promise<void> => {
  ...
  console.log('[Seed] Datos demo insertados.');
};
